...
class calculateHierarchyModelEntropy:
    ...
    def construct_comparative_judgement_transition_probability_matrix(self):
        ...
        self.chung_laplacian_network_base = (self.comparative_judgement_network
                                                 .__class__()                  )
        self.chung_laplacian_network_base.add_edges_from(ebunch_to_add = self.comparative_judgement_network
                                                                             .edges(data = True)            )
        self.chung_laplacian_network_base.add_edges_from(
                                                         ebunch_to_add = self.comparative_judgements
                                                                             .loc[lambda Ξ : Ξ['importance'] == 1 ]
                                                                             .assign(
                                                                                     comparative_factor = lambda Η : Η['comparative_factor']
                                                                                                                      .apply(func = lambda η : self.hierarchy_model
                                                                                                                                               + ':'
        ...
        comparative_judgement_transition_edge_weight_explicit = (
                                                                 DataFrame(data = self.chung_laplacian_network_base
                                                                           ...
                                                                           columns = ['comparative_factor',
                                                                                      'reference_factor',
                                                                                      'importance'         ]           )
                                                                     .assign(intensity_importance = lambda Υ : Υ['importance']
                                                                                                                .apply(func = lambda υ : υ.get('importance')))
                                                                     [['comparative_factor',
                                                                       'reference_factor',
        ...
        comparative_judgement_transition_edge_weight_sink = (
                                                             DataFrame(data = product(self.chung_laplacian_network_base
                                                                                          .nodes(),
                                                                                     DataFrame(data = dict(self.chung_laplacian_network_base.out_degree()).values(),
                                                                                               index = dict(self.chung_laplacian_network_base.out_degree()).keys(),
                                                                                               columns = ['vertex_out_degree']                                           )
                                                                                         .loc[lambda Ξ : Ξ['vertex_out_degree'] == 0]
                                                                                         .index),
                                                                      columns = ['reference_factor',
                                                                                 'comparative_factor']                                                                      )
                                                                .assign(intensity_importance = 0)
                                                             )
        
        comparative_judgement_transition_edge_weight_complete = (
                                                                 concat(objs = [comparative_judgement_transition_edge_weight_explicit,
                                                                                comparative_judgement_transition_edge_weight_sink     ],
                                                                        axis = 0                                                        )
                                                                     .sort_values(by = ['reference_factor',
                                                                                        'comparative_factor'])
        ...
        vertex_in_degree_volume = (
                                     comparative_judgement_transition_edge_weight_complete
                                             ...
                                             .groupby(by = ['reference_factor'],
                                                      as_index = False          )
                                             .sum()
                                             .assign(vertex_in_degree_volume = lambda Η : Η['intensity_importance']
        ...
        self.comparative_judgement_transition_probability_matrix = (
                                                                    comparative_judgement_transition_edge_weight_complete
                                                                        ...
                                                                        .assign(vertex_transition_probability = lambda Χ : Χ['intensity_importance']
    ...
    def construct_hierarchy_model_tournament_graph(self):
        ...
        self.construct_edge_weight_digraph_bases_for_bauer_laplacian()
...
bauer_graph_edge_weight_matrix = (
                                    DataFrame(data = ho_B1.bauer_laplacian_basis_graph
                                                          .edges(data = True),
                                              columns = ['comparative_element',
                                                         'reference_element',
                                                         'importance_intensity']       )
...
bauer_normalized_laplacian = (identity_matrix.sub(other = inverse_vertex_in_degree.dot(other = bauer_graph_edge_weight_matrix)))
...
matrix_rank(bauer_normalized_laplacian)
